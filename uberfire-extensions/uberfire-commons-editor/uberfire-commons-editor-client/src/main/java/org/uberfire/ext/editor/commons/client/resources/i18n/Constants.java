...
public interface Constants {
    ...
    @TranslationKey(defaultValue = "")
    public static final String SavePopUpView_EnterComment = "SavePopUpView.EnterComment";
    ...
    @TranslationKey(defaultValue = "")
    public static final String DeletePopUpView_EnterComment = "DeletePopUpView.EnterComment";
}
