...
public class DeletePopUpView implements DeletePopUpPresenter.View {
    ...
    private void commentTextBoxSetup() {
        ...
        commentTextBox.setPlaceholder( t( Constants.DeletePopUpView_EnterComment ) );
    }
    ...
    private void modalSetup() {
        this.modal = new CommonModalBuilder()
                .addHeader( t( Constants.DeletePopUpView_ConfirmDelete ) )
                .addBody( view )
                .addFooter( footer() )
                .build();
    }
    ...
    private ModalFooter footer() {
        ...
        footer.addButton( t( Constants.DeletePopUpView_Cancel ), cancelCommand(), ButtonType.DEFAULT );
        footer.addButton( t( Constants.DeletePopUpView_Delete ), deleteCommand(), IconType.REMOVE, ButtonType.DANGER );
        return footer;
    }
    ...
    private Command deleteCommand() {
        return new Command() {
            @Override
            public void execute() {
                presenter.delete( commentTextBox.getText() );
            }
        };
    }
